...
class MetaTubeAgent(Agent.Movies):
    ...
    agent_search_semaphore = threading.Semaphore(3)
    agent_update_semaphore = threading.Semaphore(1)
    ...
    def search(self, results, media, lang, manual=False):
        with self.agent_search_semaphore:
    ...
    def update(self, metadata, media, lang, force=False):
        with self.agent_update_semaphore:
